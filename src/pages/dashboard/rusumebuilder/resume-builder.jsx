      ...
      >
        ...
        <div className="flex gap-5 items-center justify-start align-middle">
          ...
          <div className="flex justify-end animate-bounce">
            <button
              type="button"
              onClick={() => navigate("/dashboard/resume-home")}
              className="px-5 py-2 rounded-lg bg-gradient-to-r from-primary to-secondary text-white font-semibold shadow-md hover:scale-105 transform transition"
            >
              ✨ Create Resume By One Click
            </button>
          </div>
        </div>
      </div>
