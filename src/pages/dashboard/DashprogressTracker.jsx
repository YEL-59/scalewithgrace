...
const ProgressTracker = ({ currentStage, overallProgress, allgoals }) => {
  ...
  const stages = allgoals.map((goal, index) => {
    const status =
  ...
  return (
    <div className="bg-white my-9 mb-9 rounded-4xl p-6 shadow-sm container mx-auto">
      {/* Header */}
      <div className="mb-8">
      ...
      {/* Stages Grid */}
      <div className="flex gap-4 overflow-x-scroll  max-w-full">
        {stages.map((stage) => (
          <div
            key={stage.id}
