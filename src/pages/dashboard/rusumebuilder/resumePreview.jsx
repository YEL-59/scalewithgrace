      ...
      <div className="flex mb-8">
        ...
        <div>
          <div className="h-2- w-20">
            {values?.imagePreview && (
              <img
                src={values.imagePreview} // use the preview URL, not the File object
                alt="Profile"
        ...
        <div className="flex items-start">
          ...
          <div className="">
            {(skills || [])
              .filter(
                (category) =>
                  category.title || (category.badges && category.badges.length)
              )
              .map((category, idx) => (
                <div key={idx} className="mb-4">
                  {category.title && (
