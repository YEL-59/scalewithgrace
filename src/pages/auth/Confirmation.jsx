    ...
    <div className="font-poppins max-h-screen w-11/12 lg:w-3/4 xl:w-1/2 mx-auto">
      <div className="mx-auto my-4 md:my-5 lg:my-6 xl:my-[30px]">
        ...
        <button
          ...
          className="bg-gradient-to-r from-primary to-secondary w-full rounded-[60px] py-4 text-white text-base lg:text-lg mt-6 mb-4"
        >
          <input type="submit" value="Go Back To Sign In" />
        </button>
      </div>
    </div>
  );
