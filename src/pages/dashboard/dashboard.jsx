    ...
    <div className="w-11/12 mx-auto py-8">
      ...
      {/* <div className="bg-white my-9 mb-9 rounded-4xl p-6 shadow-sm">
        ...
        <div className="flex gap-4 items-center my-4">
          <svg className="bg-[#DCDBEB] rounded-full p-3 size-12" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="url(#paint0_linear_8836_6855)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M12 18C15.3137 18 18 15.3137 18 12C18 8.68629 15.3137 6 12 6C8.68629 6 6 8.68629 6 12C6 15.3137 8.68629 18 12 18Z" stroke="url(#paint1_linear_8836_6855)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M12 14C13.1046 14 14 13.1046 14 12C14 10.8954 13.1046 10 12 10C10.8954 10 10 10.8954 10 12C10 13.1046 10.8954 14 12 14Z" stroke="url(#paint2_linear_8836_6855)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            <defs>
              <linearGradient id="paint0_linear_8836_6855" x1="26.6124" y1="12.0412" x2="-0.69081" y2="13.3849" gradientUnits="userSpaceOnUse">
                <stop stop-color="#504999" />
                <stop offset="1" stop-color="#44A199" />
              </linearGradient>
              <linearGradient id="paint1_linear_8836_6855" x1="20.7674" y1="12.0247" x2="4.38551" y2="12.831" gradientUnits="userSpaceOnUse">
                <stop stop-color="#504999" />
                <stop offset="1" stop-color="#44A199" />
              </linearGradient>
              <linearGradient id="paint2_linear_8836_6855" x1="14.9225" y1="12.0082" x2="9.46184" y2="12.277" gradientUnits="userSpaceOnUse">
                <stop stop-color="#504999" />
                <stop offset="1" stop-color="#44A199" />
              </linearGradient>
            </defs>
          ...
          <div>
            <p className="text-sm md:text-base text-[#0a0a0a]">Goal Setting & Strategy Development</p>
            <p className="text-[#6B7280] text-xs md:text-sm">Stage 2 of 6 • 33% Complete </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-xs md:text-sm my-6 flex items-center justify-around">
            ...
            <div className="flex flex-col justify-center items-center">
              <svg className="bg-[#F3F4F6] p-2 size-10 rounded-full" xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                <path d="M10.5 5.83301V17.4997" stroke="#9CA3AF" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M3.00033 15C2.77931 15 2.56735 14.9122 2.41107 14.7559C2.25479 14.5996 2.16699 14.3877 2.16699 14.1667V3.33333C2.16699 3.11232 2.25479 2.90036 2.41107 2.74408C2.56735 2.5878 2.77931 2.5 3.00033 2.5H7.16699C8.05105 2.5 8.89889 2.85119 9.52401 3.47631C10.1491 4.10143 10.5003 4.94928 10.5003 5.83333C10.5003 4.94928 10.8515 4.10143 11.4766 3.47631C12.1018 2.85119 12.9496 2.5 13.8337 2.5H18.0003C18.2213 2.5 18.4333 2.5878 18.5896 2.74408C18.7459 2.90036 18.8337 3.11232 18.8337 3.33333V14.1667C18.8337 14.3877 18.7459 14.5996 18.5896 14.7559C18.4333 14.9122 18.2213 15 18.0003 15H13.0003C12.3373 15 11.7014 15.2634 11.2326 15.7322C10.7637 16.2011 10.5003 16.837 10.5003 17.5C10.5003 16.837 10.2369 16.2011 9.76809 15.7322C9.29925 15.2634 8.66337 15 8.00033 15H3.00033Z" stroke="#9CA3AF" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
              <p>Stage 3</p>
              <p>Locked</p>
            </div>
            ...
            <div className="flex flex-col justify-center items-center">
              <svg className="bg-[#F3F4F6] p-2 size-10 rounded-full" xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                <path d="M17.9997 13.333H14.6663C14.2061 13.333 13.833 13.7061 13.833 14.1663V17.4997C13.833 17.9599 14.2061 18.333 14.6663 18.333H17.9997C18.4599 18.333 18.833 17.9599 18.833 17.4997V14.1663C18.833 13.7061 18.4599 13.333 17.9997 13.333Z" stroke="#9CA3AF" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M6.33366 13.333H3.00033C2.54009 13.333 2.16699 13.7061 2.16699 14.1663V17.4997C2.16699 17.9599 2.54009 18.333 3.00033 18.333H6.33366C6.7939 18.333 7.16699 17.9599 7.16699 17.4997V14.1663C7.16699 13.7061 6.7939 13.333 6.33366 13.333Z" stroke="#9CA3AF" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M12.1667 1.66699H8.83333C8.3731 1.66699 8 2.04009 8 2.50033V5.83366C8 6.2939 8.3731 6.66699 8.83333 6.66699H12.1667C12.6269 6.66699 13 6.2939 13 5.83366V2.50033C13 2.04009 12.6269 1.66699 12.1667 1.66699Z" stroke="#9CA3AF" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M4.66699 13.3333V10.8333C4.66699 10.6123 4.75479 10.4004 4.91107 10.2441C5.06735 10.0878 5.27931 10 5.50033 10H15.5003C15.7213 10 15.9333 10.0878 16.0896 10.2441C16.2459 10.4004 16.3337 10.6123 16.3337 10.8333V13.3333" stroke="#9CA3AF" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M10.5 10.0003V6.66699" stroke="#9CA3AF" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
              <p>Stage 4</p>
              <p>Locked</p>
            </div>
            ...
            <div className="flex flex-col justify-center items-center">
              <svg className="bg-[#F3F4F6] p-2 size-10 rounded-full" xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                <path d="M3 2.5V15.8333C3 16.2754 3.17559 16.6993 3.48816 17.0118C3.80072 17.3244 4.22464 17.5 4.66667 17.5H18" stroke="#9CA3AF" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M16.333 7.5L12.1663 11.6667L8.83301 8.33333L6.33301 10.8333" stroke="#9CA3AF" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
              <p>Stage 5</p>
              <p>Locked</p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 xl:gap-8">
        ...
        <div className="bg-gradient-to-r from-primary to-secondary p-11 relative rounded-[36px] text-white col-span-1 xl:col-span-2">
          <h4 className="text-3xl md:text-4xl lg:text-[40px] xl:text-5xl font-semibold">Why upgrade Karially?</h4>
          <div className="absolute top-6 left-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="42" viewBox="0 0 45 42" fill="none">
              <path d="M24.822 35.4544C19.2522 34.7218 13.7166 33.8306 8.15924 32.8669" stroke="white" stroke-width="3.21791" stroke-miterlimit="1.5" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M30.0805 24.5313C24.3297 21.7248 19.0388 18.0427 13.556 14.7133" stroke="white" stroke-width="3.21791" stroke-miterlimit="1.5" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M38.6297 15.7749C35.453 11.6365 32.5873 7.0722 30.8186 2.21549" stroke="white" stroke-width="3.21791" stroke-miterlimit="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
          </div>
          <p className="text-base md:text-lg lg:text-xl xl:text-2xl my-4">Unlock features that help you build a stronger resume, <br /> prep smarter for interviews.</p>

          <div className="bg-white rounded-[100px] py-[10px] px-4 mt-3 flex gap-4 items-center w-fit">
            <p className="bg-gradient-to-r from-primary to-secondary text-transparent bg-clip-text text-sm md:text-base lg:text-lg font-medium">Try for free</p>
            <button>
              <svg className="bg-gradient-to-r from-primary to-secondary rounded-full p-2 size-9" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                <path d="M3.375 14.625L14.625 3.375M14.625 3.375V11.25M14.625 3.375H6.75" stroke="white" stroke-width="1.6875" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
            </button>
        ...
        <div className="bg-white py-[34px] px-[28px] rounded-[36px] col-span-1">
          <div className="flex justify-between">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="38" height="30" viewBox="0 0 38 30" fill="none">
              <path d="M2.54673 21.2211L0.265479 6.39363C0.0967289 5.29863 1.34423 4.55113 2.23048 5.21613L9.33798 10.5461C9.52273 10.6845 9.73374 10.7838 9.95814 10.838C10.1825 10.8921 10.4156 10.8999 10.6431 10.8609C10.8707 10.822 11.0879 10.7371 11.2815 10.6114C11.4751 10.4857 11.641 10.3219 11.7692 10.1299L17.6867 1.25488C18.3117 0.317383 19.6892 0.317383 20.3142 1.25488L26.2317 10.1299C26.3599 10.3219 26.5259 10.4857 26.7195 10.6114C26.9131 10.7371 27.1303 10.822 27.3578 10.8609C27.5853 10.8999 27.8184 10.8921 28.0428 10.838C28.2672 10.7838 28.4782 10.6845 28.663 10.5461L35.7705 5.21613C36.658 4.55113 37.9042 5.29863 37.7355 6.39363L35.4542 21.2211H2.54673ZM33.738 29.4486H4.26298C4.0376 29.4486 3.81442 29.4042 3.6062 29.318C3.39797 29.2317 3.20878 29.1053 3.04941 28.946C2.72755 28.6241 2.54673 28.1876 2.54673 27.7324V23.9636H35.4542V27.7324C35.4542 28.6799 34.6855 29.4486 33.738 29.4486Z" fill="#FFB743" />
            </svg>
          </div>

          <p className="text-base md:text-lg lg:text-xl xl:text-2xl mt-4 mb-2.5 font-medium font-read">Coaching call booking</p>
          ...
          <div className="mt-6 bg-gradient-to-r from-primary to-secondary rounded-[100px] py-[10px] px-4 my-2 flex gap-4 items-center w-fit">
            ...
            <button className="bg-white rounded-full p-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                ...
                <defs>
                  <linearGradient id="paint0_linear_8836_6925" x1="17.2195" y1="9.02901" x2="1.86142" y2="9.78488" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#504999" />
                    <stop offset="1" stop-color="#44A199" />
                  </linearGradient>
                </defs>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 xl:gap-8 my-8">
        ...
        <div className="bg-white py-[34px] px-[28px] rounded-[36px] col-span-1">
          <svg className="bg-[#DCDBEB] rounded-full p-5 size-20" xmlns="http://www.w3.org/2000/svg" width="37" height="37" viewBox="0 0 37 37" fill="none">
            <path d="M18.4246 9.5L14.8816 26.1283C14.5997 27.4516 14.7549 27.947 15.7267 28.8972L19.6568 32.7401C20.1749 33.2467 20.434 33.5 20.7559 33.5C21.0778 33.5 21.3368 33.2467 21.8549 32.7401L25.7851 28.8972C26.7569 27.947 26.912 27.4516 26.6302 26.1283L23.0872 9.5" stroke="url(#paint0_linear_8836_6932)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M16.341 5.18605C16.2399 4.40021 16.1894 4.0073 16.4198 3.75365C16.6503 3.5 17.0579 3.5 17.873 3.5H23.6387C24.4538 3.5 24.8613 3.5 25.0919 3.75365C25.3223 4.0073 25.2717 4.40021 25.1706 5.18605L25.0944 5.77896C24.8805 7.44077 24.7737 8.27167 24.2394 8.81074C24.1526 8.89832 24.0585 8.97893 23.9583 9.05175C23.3415 9.5 22.4796 9.5 20.7558 9.5C19.032 9.5 18.1701 9.5 17.5533 9.05175C17.4531 8.97893 17.3591 8.89832 17.2722 8.81074C16.7379 8.27167 16.6311 7.44077 16.4172 5.77895L16.341 5.18605Z" stroke="url(#paint1_linear_8836_6932)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M15.5059 23C14.5942 24.0387 13.8223 24.5 13.2559 24.5C12.5293 24.5 11.2213 22.6691 10.6407 21.3431C10.3683 20.7209 10.2322 20.4098 10.2592 20.0162C10.2863 19.6226 10.4647 19.3347 10.8215 18.759C12.8391 15.5036 16.2776 12.5317 18.5059 9.5" stroke="url(#paint2_linear_8836_6932)" stroke-width="1.5" stroke-linejoin="round" />
            <defs>
              <linearGradient id="paint0_linear_8836_6932" x1="29.5233" y1="21.5494" x2="13.1116" y2="21.9532" gradientUnits="userSpaceOnUse">
                <stop stop-color="#504999" />
                <stop offset="1" stop-color="#44A199" />
              </linearGradient>
              <linearGradient id="paint1_linear_8836_6932" x1="27.3314" y1="6.51235" x2="15.082" y2="7.41665" gradientUnits="userSpaceOnUse">
                <stop stop-color="#504999" />
                <stop offset="1" stop-color="#44A199" />
              </linearGradient>
              <linearGradient id="paint2_linear_8836_6932" x1="20.4085" y1="17.0309" x2="9.12688" y2="17.3362" gradientUnits="userSpaceOnUse">
                <stop stop-color="#504999" />
                <stop offset="1" stop-color="#44A199" />
              </linearGradient>
            </defs>
          ...
          <p className="text-base md:text-lg lg:text-xl xl:text-2xl mt-4 mb-2.5 font-medium font-read">Set a Career Goal</p>
          <p className="ext-[#4B5563] font-read">Pick a goal that gets you excited about what’s next.</p>
        ...
        {/* card 2 */}
        <div className="bg-white py-[34px] px-[28px] rounded-[36px] col-span-1">
          <svg className="bg-[#DCDBEB] rounded-full p-5 size-20" xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
            <g clip-path="url(#clip0_8836_6947)">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M28.7693 34.4797H6.24211C4.9076 34.4797 3.83203 33.4041 3.83203 32.0696V2.92961C3.83203 1.5951 4.9076 0.519531 6.24211 0.519531H28.7693C30.0839 0.519531 31.1595 1.5951 31.1595 2.92961V32.0696C31.1595 33.4041 30.0839 34.4797 28.7693 34.4797ZM6.24211 1.31625C5.3458 1.31625 4.62875 2.0333 4.62875 2.92961V32.0696C4.62875 32.9659 5.3458 33.683 6.24211 33.683H28.7693C29.6457 33.683 30.3628 32.9659 30.3628 32.0696V2.92961C30.3628 2.0333 29.6457 1.31625 28.7693 1.31625H6.24211Z" fill="url(#paint0_linear_8836_6947)" />
              <path fill-rule="evenodd" clip-rule="evenodd" d="M12.2373 14.4024C9.48863 14.4024 7.25781 12.1715 7.25781 9.42286C7.25781 6.67417 9.48863 4.44336 12.2373 4.44336C14.986 4.44336 17.2168 6.67417 17.2168 9.42286C17.2168 12.1715 14.986 14.4024 12.2373 14.4024ZM12.2373 5.24008C9.92682 5.24008 8.05453 7.11237 8.05453 9.42286C8.05453 11.7333 9.92682 13.6056 12.2373 13.6056C14.5478 13.6056 16.4201 11.7333 16.4201 9.42286C16.4201 7.11237 14.5478 5.24008 12.2373 5.24008Z" fill="url(#paint1_linear_8836_6947)" />
              <path fill-rule="evenodd" clip-rule="evenodd" d="M8.43299 12.3707C8.07447 12.3707 7.89521 11.9524 8.13422 11.6935C10.2455 9.40294 14.2291 9.40294 16.3404 11.6935C16.699 12.072 16.1213 12.6097 15.7628 12.2313C13.9702 10.2793 10.5045 10.2993 8.71184 12.2313C8.65209 12.311 8.53258 12.3707 8.43299 12.3707Z" fill="url(#paint2_linear_8836_6947)" />
              <path fill-rule="evenodd" clip-rule="evenodd" d="M12.2371 9.44303C11.2213 9.44303 10.3847 8.60647 10.3847 7.59065C10.3847 6.55492 11.2213 5.73828 12.2371 5.73828C13.2729 5.73828 14.1094 6.55492 14.1094 7.59065C14.1094 8.60647 13.2729 9.44303 12.2371 9.44303ZM12.2371 6.535C10.8429 6.535 10.8429 8.64631 12.2371 8.64631C13.6314 8.64631 13.6314 6.535 12.2371 6.535ZM27.3349 17.3704H7.65598C7.13811 17.3704 7.13811 16.5737 7.65598 16.5737H27.3349C27.8727 16.5737 27.8727 17.3704 27.3349 17.3704ZM27.3349 21.7523H7.65598C7.13811 21.7523 7.13811 20.9755 7.65598 20.9755H27.3349C27.8727 20.9755 27.8727 21.7523 27.3349 21.7523ZM27.3349 26.1542H7.65598C7.13811 26.1542 7.13811 25.3575 7.65598 25.3575H27.3349C27.8727 25.3575 27.8727 26.1542 27.3349 26.1542ZM17.6548 30.5561H7.65598C7.13811 30.5561 7.13811 29.7594 7.65598 29.7594H17.6548C18.1727 29.7594 18.1727 30.5561 17.6548 30.5561ZM26.837 8.58655H19.1287C18.6109 8.58655 18.6109 7.78983 19.1287 7.78983H26.837C27.3549 7.78983 27.3549 8.58655 26.837 8.58655ZM26.837 12.9685H19.1287C18.6109 12.9685 18.6109 12.1718 19.1287 12.1718H26.837C27.3549 12.1718 27.3549 12.9685 26.837 12.9685Z" fill="url(#paint3_linear_8836_6947)" />
            </g>
            <defs>
              <linearGradient id="paint0_linear_8836_6947" x1="37.4618" y1="17.5695" x2="0.123578" y2="19.0482" gradientUnits="userSpaceOnUse">
                <stop stop-color="#504999" />
                <stop offset="1" stop-color="#44A199" />
              </linearGradient>
              <linearGradient id="paint1_linear_8836_6947" x1="19.5135" y1="9.44335" x2="5.91792" y2="10.1125" gradientUnits="userSpaceOnUse">
                <stop stop-color="#504999" />
                <stop offset="1" stop-color="#44A199" />
              </linearGradient>
              <linearGradient id="paint2_linear_8836_6947" x1="18.3971" y1="11.1781" x2="7.19946" y2="13.1173" gradientUnits="userSpaceOnUse">
                <stop stop-color="#504999" />
                <stop offset="1" stop-color="#44A199" />
              </linearGradient>
              <linearGradient id="paint3_linear_8836_6947" x1="32.4592" y1="18.1982" x2="4.49184" y2="19.3336" gradientUnits="userSpaceOnUse">
                <stop stop-color="#504999" />
                <stop offset="1" stop-color="#44A199" />
              </linearGradient>
              <clipPath id="clip0_8836_6947">
                <rect width="34" height="34" fill="white" transform="translate(0.505859 0.5)" />
              </clipPath>
            </defs>
          </svg>

          <p className="text-base md:text-lg lg:text-xl xl:text-2xl mt-4 mb-2.5 font-medium font-read">Built Resume</p>
          <p className="ext-[#4B5563] font-read">Turn your experience into opportunity.</p>
