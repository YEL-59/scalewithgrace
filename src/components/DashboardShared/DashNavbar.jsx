    ...
    return (
        <div className="bg-[#FFF] w-full text-sm md:text-base sticky top-0 z-50 py-7">
            <div className="w-11/12 mx-auto flex items-center justify-between">
                ...
                {/* dashboard */}
                {
                    collapsed ? <img src={logo}></img> : <h2 className='text-[#0A0E1A] text-xl md:text-2xl lg:text-[26px] xl:text-3xl leading-6 md:leading-7 lg:leading-8 xl:leading-9 font-read'>Dashboard</h2>
                }


                {/* search div for dashboard collapsed */}
                {
                    collapsed && <div className="relative flex items-center rounded-[40px] border focus-within:ring-1 focus-within:ring-ring pl-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="26" viewBox="0 0 25 26" fill="none">
                            <path d="M12.12 22.9148C6.37426 22.9148 1.69629 18.2369 1.69629 12.4911C1.69629 6.74535 6.37426 2.06738 12.12 2.06738C17.8658 2.06738 22.5437 6.74535 22.5437 12.4911C22.5437 18.2369 17.8658 22.9148 12.12 22.9148ZM12.12 3.59281C7.20815 3.59281 3.22171 7.58942 3.22171 12.4911C3.22171 17.3928 7.20815 21.3894 12.12 21.3894C17.0319 21.3894 21.0183 17.3928 21.0183 12.4911C21.0183 7.58942 17.0319 3.59281 12.12 3.59281Z" fill="#646D79" />
                            <path d="M22.7985 23.9323C22.6052 23.9323 22.412 23.8611 22.2595 23.7085L20.2256 21.6746C19.9307 21.3797 19.9307 20.8916 20.2256 20.5967C20.5205 20.3018 21.0086 20.3018 21.3035 20.5967L23.3374 22.6306C23.6324 22.9255 23.6324 23.4136 23.3374 23.7085C23.1849 23.8611 22.9917 23.9323 22.7985 23.9323Z" fill="#646D79" />
                        </svg>
                        <Input
                            type="search"
                            placeholder="Search"
